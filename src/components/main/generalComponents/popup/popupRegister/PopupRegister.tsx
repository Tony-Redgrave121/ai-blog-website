...
const PopupRegister = () => {
    ...
    return (
        <form onSubmit={handleSubmit(handleRegistration)} noValidate className={style.FormContainer}>
            ...
            <input type='text' id="user_name" placeholder="Enter your Name" {...register('user_name', registerOptions.user_name)}></input>
            </InputBlock>
            <InputBlock errors={errors} field={"user_email"} htmlFor={"user_email"} label={"Email"}>
                <input type='email' id="user_email" placeholder="Enter your Email" {...register('user_email', registerOptions.user_email)}></input>
            </InputBlock>
            <InputBlock errors={errors} field={"user_password"} htmlFor={"user_password"} label={"Password"}>
                <input type='password' id="user_password" placeholder="Enter your Password" {...register('user_password', registerOptions.user_password)}></input>
            </InputBlock>
            <div>
