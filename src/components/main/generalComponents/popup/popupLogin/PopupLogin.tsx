    ...
    return (
        <form onSubmit={handleSubmit(handleLogin)} noValidate className={style.FormContainer}>
            <InputBlock errors={errors} field={"user_email"} htmlFor={"user_email"} label={"Email"}>
                <input type='email' id="user_email" placeholder="Enter your Email" {...register('user_email', loginOptions.user_email)}></input>
            </InputBlock>
            <InputBlock errors={errors} field={"user_password"} htmlFor={"user_password"} label={"Password"}>
                <input type='password' id="user_password" placeholder="Enter your Password" {...register('user_password', loginOptions.user_password)}></input>
            </InputBlock>
            <div>
